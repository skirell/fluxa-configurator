...
/**
 * Якоря (#slug) заголовков полей на страницах документации.
...
const FIELD_ANCHORS: Record<string, Record<string, string>> = {
	...
	light_variant_color: {
		...
		brightness_state_topic: 'brightness_state_topic',
		brightness_scale: 'brightness_scale',
		color_command_topic: 'color_command_topic',
	...
	light_variant_temperature: {
		...
		brightness_state_topic: 'brightness_state_topic',
		brightness_scale: 'brightness_scale',
		temp_command_topic: 'temp_command_topic',
		temp_state_topic: 'temp_state_topic',
		min_temp: 'min_temp-max_temp',
		max_temp: 'min_temp-max_temp',
	...
	cover_variant_slider: {
		...
		open_command_topic: 'open_command_topic',
		close_command_topic: 'close_command_topic',
		stop_command_topic: 'stop_command_topic',
	...
	music: {
		...
		channels: 'channels',
		prev_command_topic: 'prev_command_topic',
		next_command_topic: 'next_command_topic',
		play_command_topic: 'play_command_topic',
		pause_command_topic: 'pause_command_topic',
		PlayPause_state_topic: 'playpause_state_topic',
		payload_prev: 'payload_prev',
		payload_play: 'payload_play',
		payload_pause: 'payload_pause',
		payload_next: 'payload_next',
		volume_command_topic: 'volume_command_topic',
		volume_state_topic: 'volume_state_topic',
